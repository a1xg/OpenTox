...
# примерная стратегия просеивания слов:
# replace E регуляркой после корректировки в список
# удалить переносы строки, привести в lowercase
# прогнать fuzz по словарю и replase все совпадения более 80-90% в список
# удалить скобки и прочие спецсимволы регуляркой
# еще раз прогнать fuzz по словарю и replase все совпадения более 80-90% в список



# TODO
#  конструкции со слэшем ,'word/word', должны быть объединены пробелом
#  конструкции со скобками ,'word1 (word2) word3', должны быть ,'word1 word3','word2',
#  фильтр слов короче 3 символов надо убрать, т.к. бывают и 3 символьные аббревиатуры
#  добавить фильтры 'or and made from natural favouring ragulators' усилители вкуса и аромата натуральные вкусоароматические вещества

class TextPostprocessing:
    def __init__(self, lang:str, text:list):
        self.lang = lang
        self.string = text
        self.__keywords = KeyWords(lang)
        self.wordlist = [] # выходной список найденных слов
        self.longstrings = [] # список очень длинных строк
        self.enums = []
        self.getClearText()
